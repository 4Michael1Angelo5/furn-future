...
class Frame extends React.Component{
    ...
    render(){
        var width  =  this.props.activeFrameIsOpen?(this.props.orientation === "landscape"? "16.667vw" : "16.5vw") :(this.props.orientation === "landscape"? "100%" : "100%") ;
        var height = this.props.activeFrameIsOpen? (this.props.orientation === "landscape"? `${this.props.PageHeight/5}px` : `${this.props.PageHeight*.156667}px`):(this.props.orientation === "landscape"? `${this.props.PageHeight/2}px` : `${this.props.PageHeight/3}px` ) ;
...
render(){
    ...
    var height  =  (this.props.orientation === "landscape"?`${this.props.PageHeight*.8}px`:`${this.props.PageHeight/2}px`); 
        ...
        return(
            <div className  = {`${grid}`} >
                <div className = "description-card">
                    ...
                    style = {{color:"black",
                            padding:"1.5rem",
                            height:`${this.props.PageHeight*.3}px`
                     }}>
                ...
                <div className = " row d-flex justify-content-center"> 
                    {this.checkActiveFrame(this.state.activeItem) ===false?null:
                     <ActiveFrame 
                        ...
                        item={this.props.content[this.checkActiveFrame(this.state.activeItem)]}
                        />}          
                    {this.checkActiveFrame(this.state.activeItem) ===false?null: 

                    <ActiveFrameDesciption 
                        PageHeight = {this.props.PageHeight}
                        returnView = {this.returnView} 
                        orientation = {this.state.orientation} 
                        item={this.props.content[this.checkActiveFrame(this.state.activeItem)]}>
                    ...
                    {this.props.content.map((item,index)=>{
                        ...
                        <Frame 
                         ...
                         activeFrameIsOpen ={this.checkActiveFrame(this.state.activeItem)===false?false:true} 
